...
mutation_setup = {'logic':0.2, 'complex':0.2, 'taskset': 0.2, 'begin-end': 0.1, 'directed':0.1}  # each key holds the percent of chance that each mutation has of taking place
